class CrownsController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @crown.save
        ...
        format.json { render :show, status: :created, location: @crown }
      else
  ...
  def update
    respond_to do |format|
      if @crown.update(crown_params)
        ...
        format.json { render :show, status: :ok, location: @crown }
      else
  ...
  def destroy
    @crown.destroy
    respond_to do |format|
      format.html { redirect_to crowns_url, notice: 'Crown was successfully destroyed.' }
  ...
  private
    ...
    def crown_params
      params.require(:crown).permit(:tweet_id, :user_id)
    end
end
